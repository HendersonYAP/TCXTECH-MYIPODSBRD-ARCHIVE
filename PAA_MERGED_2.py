...
class MYFOLIOWindow(tk.Toplevel):
    ...
    def __init__(self, parent, preloaded_rows=None, preloaded_portfolios=None):
        ...
        if preloaded_portfolios is not None:
    ...
    def _on_loaded(self, portfolios: dict):
        ...
        if portfolios is None:
            ...
            self._on_error('Portfolio build returned no data (internal error).')
            return
    ...
    def _load_thread(self, path, prefer_online=True):
        try:
            ...
            try:
                ...
                self._newpor_validation = {"ok": False, "errors": [str(newpor_exc)],
                                           "warnings": [], "row_count": 0, "checked_at": None}
