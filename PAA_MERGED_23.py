...
class MYIPOApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        tk.Button(top, text='📡  SCA Tracker', command=self._open_sca,
...
class SCAWindow(tk.Toplevel):
    ...
    def _build_portfolio_chart(self):
        ...
        panel = tk.Frame(self, bg=self.PANEL, highlightbackground=self.BORDER,
    ...
    def _build_error_banner(self):
        self._banner_frame = tk.Frame(self, bg='#1a0a0a', highlightbackground=self.RED,
                                      highlightthickness=1)
    ...
    def _build_summary_cards(self):
        cards_row = tk.Frame(self, bg=self.BG)
    ...
    def _build_tabs(self):
        tab_row = tk.Frame(self, bg=self.BG)
    ...
    def _build_weight_section(self):
        self._weight_frame = tk.Frame(self, bg=self.PANEL, highlightbackground=self.BORDER,
    ...
    def _build_footer(self):
        ...
        tk.Label(footer,
                 text='GS = Google Sheet · MAN = manually added · Click any row to expand 1Y chart',
                 font=('Courier New', 7), fg=self.DIM, bg=self.BG).pack()
