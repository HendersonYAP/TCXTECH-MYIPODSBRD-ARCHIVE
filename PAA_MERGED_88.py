...
class MYIPOApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        opie_dash_entry.bind('<Return>', lambda e: self._opie_dash_chat_submit(opie_dash_entry))
        opie_dash_entry.pack(side='left')
        tk.Button(opie_dash_box, text='🤖', font=('Segoe UI', 8), relief='flat',
                  bg='#21262d', fg='#00C9FF', cursor='hand2',
                  command=lambda: self._opie_dash_chat_submit(opie_dash_entry)).pack(side='left', padx=(3, 0))
...
class SCAWindow(tk.Toplevel):
    ...
    def _build_header(self):
        ...
        opie_entry.bind('<Return>', lambda e: self._opie_chat_submit(opie_entry))
        opie_entry.pack(side='left')
        tk.Button(opie_box, text='🤖', font=('Segoe UI', 8), relief='flat',
                  bg='#1a2035', fg=self.TEAL, cursor='hand2',
                  command=lambda: self._opie_chat_submit(opie_entry)).pack(side='left', padx=(3, 0))
