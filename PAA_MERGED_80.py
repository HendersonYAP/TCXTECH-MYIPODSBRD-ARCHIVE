    ...
    def _sor_run_and_popup(self):
        ...
        for sym, region, units in holdings_all:
            ...
            if mode == 'custom':
                ...
                # any position earns at all.
                if units < cfg.get('default_min_units', 0):
                    cr = 0
                elif region == 'US':
                    cr = SaveForRewards.calculate_position_cr(
                        region, units, is_custom=True,
...
class SCAWindow(tk.Toplevel):
    ...
    def _open_sor_settings(self):
        ...
        default_fields = [
            ('default_min_units',    'Default mode: min units held to earn'),
...
_DEFAULT_SETTINGS = {
    ...
    "sor_config": {
        ...
        "default_min_units":   1.0,    # default mode only: min units held to qualify for SoR at all
