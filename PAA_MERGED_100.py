...
# ── ENHANCED YIELD SERIES — distribution-class CEFs, each pairing a plain
# index/bond ETF with its "wrapper" income/covered-call twin (TLTW, HYGW,
# LQDW, QQQI, SPYI, IWMI…). Same closed-end mechanics as VFUND_CONFIG
# (fixed shares from launch, no rebalance) EXCEPT the split between the two
# legs is NOT equal-weight — it's driven by the 'weights' dict below instead
# of 1/N, tilted toward the wrapper's higher distribution yield.
#
...
ENHANCED_YIELD_CONFIG = [
    {
        'label':   'Enhanced Yield for Treasury Fund',
    ...
    {
        'label':   'Enhanced Yield for High Yield Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
        'members': ['HYGW', 'HYG'],
    ...
    {
        'label':   'Enhanced Yield for Investment Grade Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
        'members': ['LQDW', 'LQD'],
    ...
    {
        'label':   'Enhanced Yield Mixed Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
    ...
    {
        'label':   'Enhanced Yield for Nasdaq 100 Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
        'members': ['QQQI', 'QQQM'],
    ...
    {
        'label':   'Enhanced Yield for S&P 500 Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
        'members': ['SPYI', 'SPY'],
    ...
    {
        'label':   'Enhanced Yield for Dow Jones Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
    ...
    {
        'label':   'Enhanced Yield for Russell 2000 Fund',
        'ccy':     'USD', 'par': 1.0000, 'suffix': '',
        'members': ['IWMI', 'IWM'],
...
class MYIPOApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        _make_section(top_block, 'Top Series (Monthly Rebalanced)',
                      TOP_SERIES_LABELS + [CHAMPIONS_LABEL, ANNUAL_WINNERS_LABEL], accent='#FFD700')
